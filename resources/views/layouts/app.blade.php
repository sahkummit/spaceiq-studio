        ...
        <div class="w-full transition-all duration-300 pointer-events-auto"
            ...
            <div class="flex items-center justify-between gap-8 w-full">
                ...
                <a href="{{ route('home') }}" class="flex-shrink-0 flex items-center group">
                    <img src="{{ asset('img/logo.png') }}" alt="SpaceIQ Design Studio" class="w-auto drop-shadow-lg transition-all duration-300 group-hover:scale-105" :class="scrolled ? 'h-11' : 'h-16'">
                </a>
        ...
        <div class="container mx-auto px-6 max-w-7xl">
            <div class="grid grid-cols-1 md:grid-cols-12 gap-12 mb-16">
                ...
                <div class="col-span-1 md:col-span-4">
                    <a href="{{ route('home') }}" class="flex items-center mb-6 group">
                        <img src="{{ asset('img/logo.png') }}" alt="SpaceIQ Design Studio" class="h-14 w-auto drop-shadow-[0_0_15px_rgba(26,158,150,0.15)] opacity-90 group-hover:opacity-100 transition-opacity">
                    </a>
