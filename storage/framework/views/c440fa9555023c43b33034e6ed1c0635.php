    ...
    <div class="w-full">
        ...
        <div style="display:flex; width:100%;">
            ...
            <a href="<?php echo e(route('service.show', $svc->slug)); ?>"
               ...
               style="height:440px; <?php echo e(!$isLast ? 'border-right:1px solid rgba(255,255,255,0.07);' : ''); ?>">

                
                <div class="absolute inset-0 bg-cover bg-center transition-transform duration-700 ease-in-out group-hover:scale-[1.07]"
                     style="background-image:url('<?php echo e($img); ?>');"></div>
                ...
                <div class="absolute bottom-0 left-0 right-0 px-6 pb-7 pt-12">
                    <h4 class="text-white font-semibold text-base mb-2 leading-snug" style="font-family:'Montserrat',sans-serif;letter-spacing:0.02em;"><?php echo e($svc->title); ?></h4>
                    <p class="text-white/45 text-xs leading-relaxed mb-4" style="font-size:11px;line-height:1.6;"><?php echo e($desc); ?></p>
